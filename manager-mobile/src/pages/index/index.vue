...
function openCreateDialog() {
  message
    .prompt({
      ...
      inputValue: '',
      inputPattern: /^[\p{L}0-9\s_-]{1,50}$/u,
              ...
              <view class="card-main">
                ...
                <view class="model-info">
                  <text class="model-text">
                    Mô hình ngôn ngữ: {{ agent.llmModelName }}
                  </text>
                  <text class="model-text">
                    Giọng nói: {{ agent.ttsModelName }} ({{ agent.ttsVoiceName }})
                  </text>
                </view>
...
// Dải chuyển tiếp vào vùng nội dung
...
html.dark-mode .banner-section,
body.dark-mode .banner-section { background: linear-gradient(145deg, #0f172a, #1e3a8a, #111827, #0f172a); }
html.dark-mode .empty-state :deep(.empty-icon),
body.dark-mode .empty-state :deep(.empty-icon) { color: #475569; }
</style>
