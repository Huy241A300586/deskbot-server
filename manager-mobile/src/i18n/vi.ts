...
export default {
    ...
    'login.selectLanguageTip': 'Tiếng Việt',
    ...
    'home.subtitle': 'Quản lý trợ lý và thiết bị với',
    'home.wonderfulDay': 'DeskBot',
    'home.emptyState': 'Chưa có trợ lý nào',
    'home.deviceManagement': 'Quản lý thiết bị',
    'home.lastConversation': 'Cuộc trò chuyện cuối:',
    'home.delete': 'Xóa',
    'home.createFirstAgent': 'Nhấn nút + ở góc dưới bên phải để tạo trợ lý đầu tiên của bạn',
    'home.dialogTitle': 'Tạo trợ lý',
    'home.inputPlaceholder': 'Ví dụ: Trợ lý chăm sóc khách hàng, Trợ lý giọng nói, Trợ lý kiến thức',
    'home.createError': 'Vui lòng nhập tên trợ lý',
    ...
    // Về chúng tôi
    'settings.aboutApp': 'Về DeskBot',
    'settings.aboutContent': 'DeskBot\n\nỨng dụng quản lý di động giúp bạn quản lý trợ lý và thiết bị DeskBot trên giao diện H5/mobile một cách gọn gàng, nhất quán và dễ dùng.\n\n© 2025 DeskBot {version}',
